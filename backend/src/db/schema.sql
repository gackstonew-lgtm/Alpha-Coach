...
CREATE TABLE IF NOT EXISTS users (
  ...
  subscription_tier TEXT NOT NULL DEFAULT 'PRO', -- 'FREE' | 'PRO' | 'PREMIUM'
...
CREATE TABLE IF NOT EXISTS trading_accounts (
  ...
  account_type TEXT NOT NULL DEFAULT 'hedging', -- 'hedging' | 'netting'
  is_active INTEGER NOT NULL DEFAULT 1,
  last_synced_at TEXT,
  created_at TEXT NOT NULL DEFAULT CURRENT_TIMESTAMP,
  updated_at TEXT NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS raw_orders (
  ...
  type INTEGER NOT NULL, -- MT5 order type (0: buy, 1: sell, 2: buy_limit, 3: sell_limit, 4: buy_stop, 5: sell_stop)
...
CREATE TABLE IF NOT EXISTS raw_deals (
  ...
  symbol TEXT NOT NULL,
  type INTEGER NOT NULL, -- MT5 deal type (0: buy, 1: sell)
  entry INTEGER NOT NULL, -- MT5 deal entry (0: in, 1: out, 2: inout, 3: out_by)
...
CREATE TABLE IF NOT EXISTS reconstructed_positions (
  ...
  session_name TEXT, -- 'Asia' | 'London' | 'New York' | 'London/NY Overlap' | 'Off-Hours'
  exit_reason TEXT DEFAULT 'UNKNOWN', -- 'SL_HIT' | 'TP_HIT' | 'MANUAL' | 'SO_HIT' | 'PARTIAL' | 'UNKNOWN'
...
CREATE TABLE IF NOT EXISTS position_executions (
  ...
  deal_id TEXT NOT NULL,
  order_id TEXT NOT NULL,
  execution_type TEXT NOT NULL, -- 'ENTRY' | 'SCALE_IN' | 'PARTIAL_EXIT' | 'FINAL_EXIT'
  volume REAL NOT NULL,
  price REAL NOT NULL,
...
CREATE TABLE IF NOT EXISTS mistake_tags (
  ...
  user_id TEXT NOT NULL REFERENCES users(id) ON DELETE CASCADE,
  name TEXT NOT NULL,
  category TEXT NOT NULL, -- 'PSYCHOLOGY' | 'EXECUTION' | 'RISK' | 'STRATEGY'
...
CREATE TABLE IF NOT EXISTS trade_journals (
  ...
  confluences TEXT, -- Comma-separated or JSON array of confluences: e.g. ["Liquidity Sweep", "MSS", "FVG"]
  bias TEXT DEFAULT 'NEUTRAL', -- 'BULLISH' | 'BEARISH' | 'NEUTRAL'
  entry_trigger TEXT,
  exit_trigger TEXT,
  confidence_score INTEGER DEFAULT 5, -- 1 to 10
  emotion_state TEXT, -- 'DISCIPLINED' | 'FOMO' | 'FEARFUL' | 'GREEDY' | 'ANXIOUS' | 'CONFIDENT'
...
CREATE TABLE IF NOT EXISTS trade_screenshots (
  ...
  stage TEXT NOT NULL DEFAULT 'CHART', -- 'BEFORE' | 'DURING' | 'AFTER' | 'CHART'
...
CREATE TABLE IF NOT EXISTS achievements (
  ...
  category TEXT NOT NULL, -- 'DISCIPLINE' | 'ANALYSIS' | 'CONSISTENCY' | 'RISK_MANAGEMENT'
...
CREATE TABLE IF NOT EXISTS notifications (
  ...
  title TEXT NOT NULL,
  message TEXT NOT NULL,
  type TEXT NOT NULL DEFAULT 'SYSTEM', -- 'SYNC' | 'RISK' | 'REVIEW' | 'REPORT' | 'SYSTEM'
