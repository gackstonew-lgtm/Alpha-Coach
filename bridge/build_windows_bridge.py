...
def build():
    print("==================================================")
    print("Building Alpha Coach MT5 Companion for Windows (v1.0.4)")
    print("==================================================")
    ...
    try:
        ...
        print("To build locally: pip install pyinstaller pystray pillow requests colorama MetaTrader5 && python bridge/build_windows_bridge.py")
